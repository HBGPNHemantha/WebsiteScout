  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 dark:bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      <div className="w-full max-w-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700/80 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] transition-colors">
        ...
        {/* Header */}
        <div className="p-5 bg-gradient-to-r from-slate-50 via-indigo-50/40 to-slate-50 dark:from-slate-900 dark:via-indigo-950/40 dark:to-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-start justify-between">
          <div>
            <div className="flex items-center space-x-2">
              <span className="text-xs px-2.5 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 capitalize border border-slate-200 dark:border-slate-700">
                {detailsModalLead.category}
              </span>
              <span className="text-xs text-slate-500 dark:text-slate-400">in {detailsModalLead.searchArea}</span>
            </div>
            <h2 className="text-xl font-extrabold text-slate-900 dark:text-slate-100 mt-1.5">
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-4 bg-slate-50 dark:bg-slate-950 rounded-xl border border-slate-200 dark:border-slate-800">
            <div>
              <span className="text-[10px] text-slate-500 dark:text-slate-500 uppercase font-bold block mb-1">Pipeline Stage</span>
              <select
                value={detailsModalLead.status}
                onChange={(e) => changeLeadStatus(leadId, e.target.value)}
                className={`w-full text-xs font-bold py-2 px-3 rounded-lg border bg-white dark:bg-slate-900 ${statusConfig.bgLight}`}
              >
            ...
            <div>
              <span className="text-[10px] text-slate-500 dark:text-slate-500 uppercase font-bold block mb-1">Website Status</span>
              {detailsModalLead.hasWebsite ? (
                <a
                  href={detailsModalLead.websiteUrl}
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center space-x-1.5 text-xs text-slate-700 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-300 py-2"
                >
                ...
                <div className="py-1.5">
                  <span className="inline-flex items-center space-x-1 px-3 py-1 rounded-md bg-rose-50 dark:bg-rose-500/20 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-500/30 text-xs font-extrabold animate-pulse">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-slate-50/80 dark:bg-slate-950/60 rounded-xl border border-slate-200 dark:border-slate-800/80 space-y-2">
              ...
              {detailsModalLead.rating > 0 && (
                <div className="flex items-center space-x-1.5 text-xs text-amber-500 dark:text-amber-400 pt-1">
                  <Star className="w-4 h-4 fill-amber-400" />
                  <span className="font-bold">{detailsModalLead.rating.toFixed(1)}</span>
                  <span className="text-slate-400 dark:text-slate-500">({detailsModalLead.totalRatings || 0} reviews on Google)</span>
                </div>
              )}
            </div>
            ...
            <div className="p-4 bg-slate-50/80 dark:bg-slate-950/60 rounded-xl border border-slate-200 dark:border-slate-800/80 space-y-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center space-x-1 text-[11px] text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 pt-1 font-semibold"
              >
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-1.5 flex items-center space-x-1">
              ...
              <input
                ...
                className="w-full sm:w-64 p-2 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs text-slate-900 dark:text-slate-200 focus:outline-none focus:border-indigo-500"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full p-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs text-slate-900 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-indigo-500 font-sans"
              />
        ...
        <div className="p-4 bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 flex flex-wrap items-center justify-between gap-3">
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3 py-2 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-500/10 rounded-xl text-xs font-semibold transition"
          >
